...
$insplaanual=  "SELECT cd_componente
                      ,ds_compo
                      ,ds_fabrica
                      ,cd_atividade
                      ,intervalo
...
$mostragrid1 = $conn->Execute($insplaanual);
	...
	<?
	 ...
	 // Montagem do cabecalho dos meses
      ...
      $datalargada=$ano."-".$passa1m."-01";
       ...
       $achaexiste= "SELECT (CASE WHEN data_termino IS NULL        THEN TO_CHAR(data_plane,'DD') ELSE TO_CHAR(data_termino,'DD') END) dia
       ...
       $sachaequide4781 = $conn->Execute($achaexiste9);
