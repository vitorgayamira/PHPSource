...
$programa="CONSULTAplanomessemanaV3.php";
...
<form action="CONSULTAplanomessemanaV3.php"  name="nome_formulario" id="nome_formulario" method="POST" >
...
{				 
                 ...
                 $semanapegou=$datapegou2->fields["0"];
...
IF ($tipoconsulta=="Definindo Semana")
{  
                 $achaMINIMOMES= "SELECT MIN(NR_MES) MESINICIO   FROM aux_semana WHERE NR_SEMANA='$semanapegou' and cd_ano='$ano'";
                 $achaMINIMOMES2 = $conn->Execute($achaMINIMOMES);
                 $mesinicio=$achaMINIMOMES2->fields["0"];
				 if ($mesinicio <"10"){$mesinicio="0".$mesinicio;}
				 
				 $achadianovo1dd77= "SELECT min(NR_DIA_INICIAL) DIA1 from aux_semana
                 WHERE nr_mes='$mesinicio' and NR_SEMANA='$semanapegou' and cd_ano='$ano' ";
				 $achadianovo1dd772 = $conn->Execute($achadianovo1dd77);
                 $primeirodia=$achadianovo1dd772->fields["0"];
				 
				 if ($primeirodia <"10"){$primeirodia="0".$primeirodia;}
				 $datalargada=$ano."-".$mesinicio."-".$primeirodia;
