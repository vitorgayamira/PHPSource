...
$sacha="select cd_equipamento, ds_equipamento,MES_03_HORA TMP_INICIO, MES_01_HORA MTBF,MTTR_MES_01_HORA MTTR, disp_01 FROM mtbf order by disp_01 asc ";

$smpegaaux2= $conn->Execute($sacha);
  while ( !$smpegaaux2->EOF)
  {
	    //$codigocomponente=$smpegaaux2->fields["0"];
		//CAMPOS ESTÃO INFORMADOS NA SEQUENCIA QUE ENCONTRAM-SE NO SELECT ACIMA
        ?>
			<tr>
...
?>
        ...
        <tr>
        <td  align=left><IMG src="<?echo $logomarcamostra;?>"></td>
		<td align=center><font style='font-size: 22px;color: black;text-align:left;bold: Negrito' >Disponibilidade HMP(%)</font></td>
        <td  align=right><a href="<? echo $programa;?>?navegando=sim&escolha=1">
        <IMG src="sairmensagem.png" width="38" height="38" ></a>
        </td>
        </tr>
...
//$sacha="select a.vl_coluna3,a.vl_coluna4 FROM aux_grafico a order by a.vl_coluna2 asc ";
$sacha="select cd_equipamento, ds_equipamento,MES_04_HORA TMP_INICIO, MES_02_HORA MTBF,MTTR_MES_02_HORA MTTR, disp_02 FROM mtbf order by disp_02 asc ";
