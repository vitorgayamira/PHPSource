...
$componenteescolha=$POST['componenteescolha'];
$atividadeescolha=$POST['atividadeescolha'];
}
$programa="CONSULTApcmanualV3.php";
                ...
                SELECT *
				  FROM (
					...
					WHERE rc.cd_componente        = oc.cd_componente
					  ...
					  AND (oc.cd_atividade        = '$atividadeescolha'     OR '$atividadeescolha'     IS NULL)
					  ...
					  AND (ma.cd_maquina          = '$equipamentoescolha' OR '$equipamentoescolha' IS NULL)
					  AND (ca.cd_compo            = '$componenteescolha'  OR '$componenteescolha' IS NULL)
					...
					WHERE ec.cd_componente         = ca.cd_compo
					  ...
					  AND (ec.cd_atividade        = '$atividadeescolha'     OR '$atividadeescolha'     IS NULL)
					  AND fa.cd_fabrica           IN (SELECT cd_unidade FROM aux_usuario_unidade WHERE cd_usuario='$edusuario')
					ORDER BY ds_fabrica,
						 cd_componente,
						 cd_atividade
