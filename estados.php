...
<form action="estado.php"  name="formulario" method="POST">
...
<CENTER><font style='font-size: 26px;color:red;text-align:left;bold: Negrito' >Cadastro de Estados </font></BR>
...
<?
 ...
 $s = OCIParse($ora_conexao, "select CD_PAIS,DS_PAIS FROM PAIS ORDER  by DS_PAIS ASC");
        OCIExecute($s, OCI_DEFAULT);
        While (OCIFetch($s)) {

          $codigo=ociresult($s, "CD_ESTADO") ;
          $descricao=ociresult($s, "DS_ESTADO") ;
