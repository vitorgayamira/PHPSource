...
<meta http-equiv="refresh" content="30;URL=painelcorretiva.php?banco=<?echo $banco;?>&codigousuario=<?echo $codigousuario;?>&localbanco=<?echo $localbanco;?>">
...
?>
 ...
 for ($passa1=$contadoriteminicial;$passa1 <=$totalordens;$passa1++){
  //echo "</br>posicao:$passa1//total por linha:$totalporlinha";
      ...
      <td bgcolor="<? echo $cor;?>" width="110" height="140"><h1 style='font-size: 15px;color: black;text-align:left;bold: Negrito text-decoration: none'>
      <?echo "$ordemmostra</br>";?><?echo "$componentemostra</br>";?><?echo "$aberturamostra</br>";?>
