...
$programa="consultaordenseuro.php";
...
if (!IsSet($dataparabuscar1)){
	             ...
	             $datapegou1 = "SELECT to_char(TRUNC(SYSDATE)-30,'yyyy-mm-dd') DATA FROM EMER_COMP WHERE STATUS <> 'B'";
				 ...
				 $datapegou12 = "SELECT to_char(TRUNC(SYSDATE)-30,'yyyy-mm-dd') DATA FROM ORDEM_COMP WHERE STATUS <> 'B'";
...
IF ($grupoordens=="C")
{
                       ...
                       $chacontadorgeral="SELECT x.*,rownum Id from (select  a.NUMERO,
                       to_char(a.DATA_INICIO,'dd/mm/yyyy') DATA,a.CD_MAQUINA MAQUINA,
					   a.CD_COMPONENTE,
					   a.OBS ,
					   a.CD_FABRICA ,
					   c.nome NOME,
					   TO_CHAR(b.data_baixa_individual,'dd/mm/yyyy') data_baixa_individual,
					   0,
					   a.RECOMENDACAO,
                       1 TIPO,
					   ...
					   b.horas HORATOTAL,
					   b.OBS_FUNC RECOMENDACAO3,a.status STATUS
					   ...
					   ORDER BY a.DATA_INICIO DESC,a.hora_inicio desc,a.minuto_inicio desc
                       ) x
                       ";
                       ...
                       $chacontadorgeral="SELECT x.*,rownum Id from (select  a.NUMERO,to_char(a.DATA_INICIO,'dd/mm/yyyy') DATA,
...
IF ($grupoordens=="T")
{
					   ...
					   to_char(a.DATA_INICIO,'dd/mm/yyyy') DATA,
					   ...
					   to_char(a.DATA_PLANE,'dd/mm/yyyy') DATA,
                       a.CD_MAQUINA MAQUINA,
					   a.CD_COMPONENTE,
					   a.OBS,
                       a.CD_FABRICA ,
					   ...
					   ORDER BY DATA DESC,HORA_INICIO DESC,MINUTO_INICIO DESC
                       )
                       ";
...
IF ($grupoordens=="P"){
                       ...
                       a.SOLICITANTE,a.RECOMENDACAO,TO_CHAR(b.data_baixa_individual,'dd/mm/yyyy') data_baixa_individual,b.hr_ini HORA1,b.hr_fim HORA2,b.horas HORATOTAL,
...
?>
<form action="consultaordenseuro.php" method="POST">
...
$sql=$tabela;
//$sql=$tabela." WHERE rownum BETWEEN ".$inicio." and ".$registros;
     ...
     while ( !$datapegou2->EOF) {
	  ...
	  ?>
      <td><? echo $datapegou2->fields("NUMERO");?></td>
      <?}
	  else
	  {
      ...
      ?>  
	   ...
	   <td><? echo $datapegou2->fields("DATA_BAIXA_INDIVIDUAL");?><? echo " ";?>
	   <? echo $datapegou2->fields("HORA1");?><? echo " -";?>
	   <? echo $datapegou2->fields("HORA2");?></td>	                  
...
?>
 ...
 <div  style="display: block;" id="telapesquisa">       
        ...
        <tr>
        <td  align=right>
        <a href="consultaordenseuro.php?navegando=sim&escolha=1">
