...
<tr>
				...
				<td><font style='font-size: 20px;color: black;text-align:left;bold: Negrito' >Quantidade de Manuten&ccedil;&atilde;o <br> CORRETIVA x Equipamento</font></td>
...
<table border=0 width=100%>
<tr>    			
	<td align=center><IMG src=GraficoCorretiva.png></td>
</tr>
</table>
...
$html.="</html>";
                 ...
                 $nomeDoArquivo="GRAFICO_CORRETIVA.pdf";
...
<table width="99%">
          ...
          <hr>
           ...
           <tr>
           <td  align=right>
           <a href="./arquivos/GRAFICO_CORRETIVA.pdf">
