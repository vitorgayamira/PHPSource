...
<form action="consultamaquinaversa3.php" name="formulario" method="POST">
 ...
 $s2 = OCIParse($ora_conexao, "select CD_FAMLIA,DS_FAMILIA FROM FAMILIAS where cd_famlia like '%$familiapesquisa%'");
  ...
  While (OCIFetch($s2)) {
      ...
      <?
        ...
        While (OCIFetch($s)) {
                        ...
                        if ($contador >"0"){
                           ...
                           <a href="#" onClick="window.open('consultamaquina2.php?fabrica=<?echo "$fabrica";?>
                            &tipoconsulta=linhacoluna&codigofamilia=<?echo "$codigofamilia";?>&modelo=<?echo "$modelopesquisa";?>&navegando=sim','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
        ...
        <td>
        <a href="#" onClick="window.open('consultamaquina2.php?fabrica=<?echo "$fabrica";?>
                            &tipoconsulta=familia&codigofamilia=<?echo "$codigofamilia";?>&modelo=<?echo "$modelopesquisa";?>&navegando=sim','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
        ...
        While (OCIFetch($sacha5)) {
                        ...
                        While (OCIFetch($quantoss19)) {
                           $quantidademaquina=ociresult($quantoss19, "CONTADOR") ;
                            ...
                            <td>
                            <a href="#" onClick="window.open('consultamaquina2.php?fabrica=<?echo "$fabrica";?>
                            &tipoconsulta=unidade1&codigofamilia=<?echo "$codigofamilia";?>&modelo=<?echo "$modelopesquisa";?>&navegando=sim','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
...
<td>
<a href="#" onClick="window.open('consultamaquina2.php?fabrica=<?echo "$fabrica";?>
                            &tipoconsulta=unidade2&codigofamilia=<?echo "$codigofamilia";?>&modelo=<?echo "$modelopesquisa";?>&navegando=sim','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
...
?>
   ...
   Etapa-3 Seleção de Distrito</br>
...
?>
   ...
   Etapa-4 Seleção de Fabricas</br>
...
<center><div class='divscroll' style='height:390;width:650'>
    Etapa-5 Seleção de famílias</br>
...
<?
  ...
  While (OCIFetch($s21)) {
      ...
      ?>
      <tr>
      <td>Região:<? echo "$descrica67";?></font></td>
      <?
                        ...
                        While (OCIFetch($quantoss1799)) {
                         ...
                         <td><a href="#" onClick="window.open('consultamaquina4.php?regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>
                            &codigofamilia=<?echo "$codigofamilia";?>&tipoconsulta=totalregiao&navegando=sim&modelo=<?echo "$codigomodelo";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
      ...
      ?>
      <tr>
         <td>Família:<? echo ociresult($s213, "CD_FAMILIA");?></font></td>
      <?
                        ...
                        While (OCIFetch($quantoss1799)) {
                         ...
                         ?>
                         <td><a href="#" onClick="window.open('consultamaquina4.php?distrito=<?echo "$codigodistrito";?>&regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>&tipoconsulta=familia&codigofamilia=<?echo "$codigofamilia";?>&navegando=sim&modelo=<?echo "$modeloteste";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
                           <? echo "$acha55";?></a></td>
                         <?
                         }
                         ...
                         <td><a href="#" onClick="window.open('consultamaquina4.php?distrito=<?echo "$codigodistrito";?>&regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>&codigofamilia=<?echo "$codigofamilia";?>&tipoconsulta=totalfamilia&navegando=sim&modelo=<?echo "$codigomodelo";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
         ...
         While (OCIFetch($s224)) {
          ...
          <?
           $acha2  = OCIParse($ora_conexao, "select distinct cd_fabrica FABRICA FROM AUX_FILTRO
                        ...
                        While (OCIFetch($quantoss1799)) {
                         ...
                         ?>
                         <td><a href="#" onClick="window.open('consultamaquina4.php?distrito=<?echo "$codigodistrito";?>&regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>&codigofamilia=<?echo "$codigofamilia";?>&tipoconsulta=modelo&navegando=sim&modelo=<?echo "$codigomodelo";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
                           <? echo "$acha55";?></a></td>
                         <?
                         }
                        ...
                        ?>
                         <td><a href="#" onClick="window.open('consultamaquina4.php?distrito=<?echo "$codigodistrito";?>&regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>&codigofamilia=<?echo "$codigofamilia";?>&tipoconsulta=totalmodelo&navegando=sim&modelo=<?echo "$codigomodelo";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
                           <? echo "$finalmodelo";?></a>
          ...
          <tr>
          <td>Ano Fabricação:<? echo ociresult($s226, "VL_ANO");?></font></td>
          <?
           $acha2  = OCIParse($ora_conexao, "select distinct cd_fabrica FABRICA FROM AUX_FILTRO
                         where cd_fabrica is not null order by CD_FABRICA asc");
                         OCIExecute($acha2, OCI_DEFAULT);
                        ...
                        While (OCIFetch($quantoss1799)) {
                         ...
                         ?>
                         <td><a href="#" onClick="window.open('consultamaquina4.php?distrito=<?echo "$codigodistrito";?>&regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>&codigofamilia=<?echo "$codigofamilia";?>&tipoconsulta=ano&navegando=sim&modelo=<?echo "$codigomodelo";?>&ano=<?echo "$anofabricacao";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
                           <? echo "$acha55";?></a></td>
                         <?
                         }
                        ...
                        ?>
                         <td><a href="#" onClick="window.open('consultamaquina4.php?distrito=<?echo "$codigodistrito";?>&regiao=<?echo "$codigoregiao";?>&fabrica=<?echo "$codigofabrica5";?>&codigofamilia=<?echo "$codigofamilia";?>&tipoconsulta=totalano&navegando=sim&modelo=<?echo "$codigomodelo";?>&ano=<?echo "$anofabricacao";?>','tela04','toolbar=no,location=no,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=900,height=550')">
                           <h1 style='font-size: 11px;color: blue;text-align:left;bold: Negrito text-decoration: none'>
                           <? echo "$finalano";?></a>
