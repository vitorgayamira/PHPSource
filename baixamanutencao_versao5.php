 ...
 <Script Language="JavaScript">
             ...
             function mascaraData(campoData){
              ...
              var data = campoData.value;
                            if (data.length == 2){
                                              data = data + '/';
                                              document.forms[0].datamaterial.value = data;      return true;
                                               }
                                               if (data.length == 5){
                                               data = data + '/';
                                  ...
                                  IF ($ultimo780=="0"){//TODOS OS SERVICOS ESTAO COMO FINALIZADOS
                                   ...
                                   else
                                   {
                                    if ($quantosrecomc=="0"){
                                       ...
                                       ?><center><?echo "Concluida Ordem Final:$numeroordempesquisa";
                                       $medeacao="novaordem";
                             ...
                             if ($quantos666p=="0")
                                   ...
                                   else
                                   {
                                    ...
                                    if ($quantosrecomp=="0"){
                                       ...
                                       ?><center><?echo "Concluida Ordem:$numeroordempesquisa";
...
<form action="baixamanutencao_versao5.php"  name=Form1  method="POST">
<body onLoad="AlternarAbas('<?echo $acha1div;?>','<?echo $acha2div;?>')">

<center><font style='font-size: 32px;color: black;text-align:left;bold: Negrito' >Baixa de Ordens</font>
<font style='font-size: 15px;color: red;text-align:left;bold: Negrito' ><?echo " Ordem Selecionada:$numeroordempesquisa</br>";?> 
...
<tr>
        ...
        <?
	     ...
	     ?>
         <tr>
         <td><center><? echo $datapegou22d456->fields["0"];?></td>
		 <td><center><? echo $datapegou22d456->fields["1"];?></td>
		 <td><center><? echo $datapegou22d456->fields["2"];?></td>
		 <td><center><? echo $datapegou22d456->fields["4"];?></td>
		 <td><center><? echo $datapegou22d456->fields["3"];?></td>
		 <td><center><? echo $datapegou22d456->fields["6"];?></td>
		 <td><center><? echo $datapegou22d456->fields["7"];?></td>
...
<table>  
                 ...
                 <td>Data:</td>
				 <td>
				 <input type="text" name="datamaterial"  OnKeyUp="mascaraData2(this);" maxlength="10"  SIZE="8" / VALUE="<?echo $dataplanejadamostra5;?>" >
                 </td>
				 </tr>
                 <tr>
                 <td>Defeito:</td>
