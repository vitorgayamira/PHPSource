...
?>
<form action="incluirusuario_mi.php"  name="teste"  method="POST" >
...
{
	?>
<a href="INCLUIRUSUARIO2.php?pagina=1&escolha=associatabelas&programa=<?echo $programa;?>&chacontadorgeral=<?echo $chacontadorgeral;?>&numerocolunastela=<?echo $numerocolunastela;?>&campolista1=<?echo $campolista1;?>&campolista2=<?echo $campolista2;?>&seelctcampolista1=<?echo $seelctcampolista1;?>&seelctcampolista2=<?echo $seelctcampolista2;?>&nometabelaparapassar=<?echo $nometabelaparapassar;?>&titulojanelaassociacao1=<?echo $titulojanelaassociacao1;?>&nometabelaassociativa1=<?echo $nometabelaassociativa1;?>&titulojanelainsert=<?echo $titulojanelainsert;?>"><img BORDER=0 src="usuario3d.png" width='55' height='55'></a>
