...
<form action="cadastrarmotivossolicitacao.php"  name="formulario" method="POST">
...
<CENTER><font style='font-size: 19px;color: BLACK;text-align:left;bold: Negrito' >Cadastro de Motivos - Solicitação de Serviços </font></BR>



<a href="cadastrarmotivossolicitacao.php?pagina=1&escolha=novoregistro&tela=0&mes=<?echo $mes;?>&ano=<?echo $ano;?>&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>&codigousuario=<?echo $codigousuario;?>&codigoempresa=<?echo $codigoempresa;?>&navegando=sim&banco=<?echo $banco;?>
...
<a href="cadastrarmotivossolicitacao.php?codigousuario=<?echo $codigousuario;?>&codigoempresa=<?ECHO $codigoempresa;?>
...
<a href="cadastrarmotivossolicitacao.php?pagina=1&escolha=novoregistro&tela=1&mes=<?echo $mes;?>&ano=<?echo $ano;?>
...
<?
 ...
 $s = OCIParse($ora_conexao, "select CD_MOTIVO,DS_MOTIVO FROM MOTIVO_SOLICITACAO ORDER  by DS_MOTIVO ASC");
...
<tr>
				...
				<th style='font-size: 9px;text-align:left;bold: Negrito'>Selecionar</th>
				 ...
				 <?
				 $contadorfamilia="0";
                 $result2 = "select cd_motivo,d_motivo FROM motivo_solicitacao";
...
if ($escolha=="3"){
                 ...
                 $sgrava1= OCIParse($ora_conexao, "insert into MOTIVO_SOLICITACAO(CD_MOTIVO,DS_MOTIVO)
...
if ($escolha=="4"){//ELIMINANDO
  ...
  if ($criafinal>"0"){
                         ...
                         from MOTIVO_SOLICITACAO WHERE CD_MOTIVO='$criafinal'");
                         ...
                         While (OCIFetch($quantoss17)) {
                           ...
                           IF ($acha55 =="0"){
                           $sgrava1= OCIParse($ora_conexao, "DELETE FROM MOTIVO_SOLICITACAO  WHERE
                           CD_MOTIVO='$criafinal'");
                           OCIExecute($sgrava1, OCI_DEFAULT);
                           oci_commit($ora_conexao);
                           }
