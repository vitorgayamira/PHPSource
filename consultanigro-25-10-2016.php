...
ini_set('display_errors', '0');// NÃO HABILITAD 
					 ...
					 $escolha=NULL;//$_GET['escolha'];
					 $navegando=NULL;
					 $continuarmesmatela=NULL;
					 $areapesquisa=NULL;
					 $secaopesquisa=NULL;
					 $centropesquisa=NULL;
					 $maquina=NULL;					 
					 ...
					 $dataanterior=NULL;	
					 $mesanterior=NULL;	
					 $sequenciarecebe=NULL;	
					 $statusacao=NULL;	
					 $padraoexecucao=NULL;	
					 $solicitantepesquisa=NULL;	
					 $pedidoaltera=NULL;	
					 $vercalendario=NULL;	
					 $acessoudiacalendario=NULL;	
					 $ficanatela=NULL;	
					 $vertudopendente=NULL;	
					 $dispminima=NULL;	
					 
require("conexaoadodb_oracle.php");
require_once('manipulasql.class_oraclenovo.php');
$programa="consultanigro.php";
$titulo="Histórico de Manutenção e Disponibilidade";
...
$continuarmesmatela=$_GET['continuarmesmatela'];
...
<a href="nigroRelatorioDispPDF.php?escolha=1&navegando=sim&banco=<?echo $banco;?>&localbanco=<?echo $localbanco;?>&usuario=<?echo $usuario;?>&ordem=<?echo $ordem?>"><IMG src="imprimirnovo.png" align="center" width='70' height='75'></a>
...
{//gera calculo
	...
	$ora_conexao = OCILogon($user,$user,$ora_bd);
            ...
            $query = ("BEGIN CARGA_NIGRO(:P_FABRICA,:P_DATA1,:P_DATA2); END;");
...
<table  border=0
 ...
 <tr>
	...
	<th>Preventiva(h)</th>
	<th>Corretiva(h)</th>
	<th>Aguardando Solicitação</th>
	<th>Nº Preventivas</th>
	<th>Nº Corretivas</th>
