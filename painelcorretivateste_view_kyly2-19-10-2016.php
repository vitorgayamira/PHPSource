...
<style  type="text/css">
#envolve { width: 100%;}
 #div_1 { position: relative; width: 49.9%; height: 1200px; background-color: #CAE1FF;float: left; text-align: center; color: #E8E8E8; z-index:-1;}
...
<meta http-equiv="refresh" content="60;URL=painelcorretivateste_view_kyly2.php?banco=<?echo $banco;?>&codigousuario=<?echo $codigousuario;?>&localbanco=<?echo $localbanco;?>">
