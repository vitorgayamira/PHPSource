...
<form action="novasolicitacaoservicoliberacao_versa2juridica.php"  name="nome_formulario" id="nome_formulario" method="POST" >
...
$today = date('d/m/y H:i:s'); 
          ...
          $achaempresasolicita1= "select COD_FORNECEDOR,EMPRESA from fornecedor_sadege where COD_FORNECEDOR='$codigoerp'";
		  ...
		  while (OCIFetchInto($achaempresasolicita2,&$row, OCI_ASSOC+OCI_RETURN_NULLS))
		  {
                ...
                $descricaoempresa=ociresult($achaempresasolicita2, "EMPRESA") ;
...
?>
<center>
Código Solicitante:<?echo $codigoerp;?>-<?echo $descricaoempresa;?>
...
<input type="hidden" name="hora" OnKeyUp="mascara_hora(this.value)" maxlength="5">
 ...
 <input type="hidden" name="ano"  value="<?echo $ano;?>" >
  ...
  <input type="hidden" name="segundasemana" value="<?echo $segundasemana;?>">
		...
		<input type="hidden" name="solicitantenovo" value="<?echo $descricaoempresa;?>">
...
if ($solicitantepesquisainicial >"0"){
    ...
    else
    {
     echo "Existe Pedido ";
       ...
       if ($fornecedor1>"0"){
         echo "Existe Empesa</br>";
         
         echo "forncedor:$fornecedor1//soicitante:$solicitantenovo";
