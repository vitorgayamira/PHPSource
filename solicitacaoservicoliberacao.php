...
<form action="solicitacaoservicoliberacao.php" method="POST" name="nome_formulario">
...
Empresa Solicitante: <select name="empresasolicita" style="background-color:#8B8378;color: white;">
	...
	Tipo de Liberação <select name="tipoexecutor" style="background-color:#8B8378;color: white;">
