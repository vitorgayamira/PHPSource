...
<form action="novasolicitacaoservicoliberacao.php"  name="nome_formulario" id="nome_formulario" method="POST" >
...
?>
<center>
Código Seção Solicitante:<?echo $codigoerp;?>-Unidade Manutenção:<?echo $codigofabricasolicitante;?>
