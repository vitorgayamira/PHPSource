...
//ABRE OS BANCOS
         ...
         FROM
         banco_bi WHERE DS_BANCO_WEB='$banco'";
...
while ($valor77=mysql_fetch_array($transmite775))
{
     ...
     $achaestado= "SELECT COUNT(*) CONTADOR from estado where cd_estado='$estadocorreio'";
     ...
     if ($existees=="0"){
        ...
        else
        {
         ...
         $grava5es= "INSERT INTO estado(cd_estado,ds_estado,cd_pais)
     ...
     $achacidade= "SELECT COUNT(*) CONTADOR from cidade where ds_cidade='$cidadecorreio'";
     ...
     if ($existecidade=="0"){
        ...
        {
        $grava5es= "INSERT INTO cidade(cd_cidade,ds_cidade,cd_estado)
     ...
     else
     {
                       ...
                       $usuachacida77= "SELECT CD_CIDADE from cidade where DS_CIDADE='$cidadecorreio'";
