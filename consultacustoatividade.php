...
$sm="select a.cd_componente CODIGOEQUIPAMENTO,
 ...
 //grava parametros
				  ...
				  if(empty($fabricapesquisa)){$gravaparametrounidade="0";}else{$gravaparametrounidade=$fabricapesquisa;}
				  ...
				  if(empty($datapesquisainicial)){$gravaparametrodata1="0";}else{$gravaparametrodata1=$datapesquisainicial;}
                  if ($sequenciaparametro >"0"){$sequenciaparametrograva=$sequenciaparametro+1;}else{$sequenciaparametrograva="1";}
				  $usu18ussMAXPED3opd = "SELECT MAX(NR_SEQUENCIA) SEQUENCIA FROM parametro_grafico";
                                        $usu18ussMAXPED23opd= $conn->Execute($usu18ussMAXPED3opd);
                                        $sequenciaparametro=$usu18ussMAXPED23opd->fields["0"];
				  ...
				  if(empty($datapesquisafinal)){$gravaparametrodata2="0";}else{$gravaparametrodata2=$datapesquisafinal;}
				  $usu18ussMAXPED3opd = "SELECT MAX(NR_SEQUENCIA) SEQUENCIA FROM parametro_grafico";
                                        $usu18ussMAXPED23opd= $conn->Execute($usu18ussMAXPED3opd);
                                        $sequenciaparametro=$usu18ussMAXPED23opd->fields["0"];
                  if ($sequenciaparametro >"0"){$sequenciaparametrograva=$sequenciaparametro+1;}else{$sequenciaparametrograva="1";}
...
<td style='font-size: 14px;color: red;text-align:left;bold: Negrito'><?


$custototal7M5=number_format($custototal7MAT, 2, ',', '.');echo $custototal7M5;?>
</td>

<td style='font-size: 14px;color: red;text-align:left;bold: Negrito'>
<?
$custototal7P5=number_format($custototal7PECA, 2, ',', '.');echo $custototal7P5;?>
</td>


<td style='font-size: 14px;color: red;text-align:left;bold: Negrito'>
<?
$custototal7=number_format($custototal7, 2, ',', '.');echo $custototal7;?>
</td>
<td></td>
</tr>
 ...
 <div  style="display: block;" id="telapesquisa">       
		...
		<table>
                ...
                <td>
                 ...
                 <td>
				   <input type=date name="datapesquisainicial" >Até <input type=date name="datapesquisafinal" >
  				 </td>
				 </tr>
