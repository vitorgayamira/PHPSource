...
<form action="consultaequipamentov10.php" method="POST" name="formulario">
...
<a href="consultaequipamentov10.php?pagina=1&dispminima=0&programa=<?echo $programa;?>&navegando=sim"><img  src="consulta.png"  align="center" width='70' height='75' ></a>
...
if ($mostradetalhe=="sim")
{
 ...
 <tr>
 <td>Detalhe dos Equipamentos da Unidade:<?echo $fabrica;?>- Família:<?echo $codigofamilia;?></td>
 </tr>
 </table>
...
<div  style="display: block;" id="telapesquisa">  
        ...
        <IMG src="sairmensagem.png" width="38" height="38" ></a>
	             ...
	             Situação da Ordem:<select   name="situacaoordem"  onchange="this.form.submit()">
...
<div  style="display: block;" id="telaresultadomaquina">  
  ...
  $codigofamilia=$s21fal2->fields["0"]; 
	  ...
	  $acha2fa= "select distinct cd_fabrica FABRICA FROM fabricas order by CD_FABRICA asc";
                         ...
                         while ( !$acha2fa6->EOF)
                        {
                         ...
                         if ($acha55 >"0"){
                         ?>
						 <td><a href="consultaequipamentov10.php?fabrica=<?echo "$codigofabrica5";?>&codigofamilia=<?echo "$codigofamilia";?>&navegando=sim&mostradetalhe=sim&dispminima=1"><? echo "$acha55";?></a>
						 </td>
                         <?
                         }
                         else
