...
<form action="pessoafisicamilenioV2.php"  name="teste"  method="POST" >
...
else
{
     ...
     $achacad7= "SELECT COUNT(*) CONTADOR from pessoa_bi
           where nr_cadastro='$cadastro' and codigo not in ('$codigoachou') ";
            $achacad27= mysql_db_query($banco,$achacad7,$conexao);
            $achacad37=mysql_fetch_array($achacad27);
            $quantos7=$achacad37["CONTADOR"];

            ECHO "$achacad7//CONTADOR:$quantos7";

     if ($quantos7 >"0"){
              $mensagemtela="N„o foi PossÌvel Incluir Novo Cadastro j· esta em USO ";
...
else
{
           ...
           where nr_cadastro='$cadastro' and codigo not in ('$codigoachou') ";
            ...
            if ($quantos7 >"0"){
              $mensagemtela="N„o foi PossÌvel Atualizar Este Cadastro j· esta em USO ";
...
<a href="pessoafisicamilenioV2.php?navegando=sim&status=novo&statusnovapessoa=sim">
<img src="incluirnovocva.png" width="42" height="38" ></a>

<a href="carregamenumaximiza.php">
<img src="sairtela.png" width="42" height="38"></a>

<a href="pessoafisicamilenioV2.php?navegando=sim&statusnovapessoa=nao&acaoparametro=selecionar&iniciotela=sim&statusparametro=buscarparametro">
...
<a href="pessoafisicamilenioV2.php?navegando=sim&status=cancelar&statusnovapessoa=sim">
<img src="sairtela.png" width="42" height="38"></a>
...
<a href="pessoafisicamilenioV2.php?navegando=sim&acaoparametro=selecionar&statusparametro=buscarparametro">
<IMG src="selecionarnovocva.png" width="42" height="38" ></a>

<a href="pessoafisicamilenioV2.php?navegando=sim&status=editar&acaoparametro=eliminar&codigopessoaatual=<?echo $codigoachou;?>&statusparametro=buscarparametro">
...
{
?>
<a href="pessoafisicamilenioV2.php?navegando=sim&status=editar&codigoachou<?echo $codigoachou;?>">
<img src="sairtela.png" width="42" height="38"></a>
<?}
...
from pessoa_bi a, cidade b
          ...
          <?
                    ...
                    P·gina:<? echo "$pagina_atual";?>/<? echo "$paginas";?>
                     <a href="pessoafisicamilenioV2.php?navegando=sim&buscarparametro=nao&pagina_atual=<?echo $anteriorpagina;?>&status=cancelar&statusnovapessoa=nao">
                     <img src="setaesquerda.png" width="20" height="14" ></a>
                    <a href="pessoafisicamilenioV2.php?navegando=sim&buscarparametro=nao&pagina_atual=<?echo $proximapagina;?>&status=cancelar&statusnovapessoa=nao">
...
<div  style="display: block;" id="mostrapessoajuridica">
          ...
          <a href="pessoafisicamilenioV2.php?navegando=sim&status=cancelar">
           <img src="sairtela.png" width="42" height="38"></a>
...
<?
	    ...
	    <td width="5%"><a href="pessoafisicamilenioV2.php?navegando=sim&status=editar&codigoachou=<?echo $codigopasa;?>&acaoparametro=<?echo $acaoparametro;?>">
 ...
 <td align=right>
    ...
    <a href="pessoafisicamilenioV2.php?navegando=sim&pagina_atual=<?echo $proximapagina;?>&status=buscarparametro&acaoparametro=selecionar&nomebusca=<?echo $nomebusca;?>&codigocidade=<?echo $codigocidade;?>&iniciotela=sim&statusparametro=buscarparametro">
    <img src="setadireita.png" width="20" height="14" ></a>
    <a href="pessoafisicamilenioV2.php?navegando=sim&buscarparametro=sim&pagina_atual=<?echo $anteriorpagina;?>&status=buscarparametro&acaoparametro=selecionar&nomebusca=<?echo $nomebusca;?>&codigocidade=<?echo $codigocidade;?>&iniciotela=sim&statusparametro=buscarparametro">
    <img src="setaesquerda.png" width="20" height="14" ></a>
    </td>
 </tr>
 </table>
...
<div  style="display: block;" id="mostraexclusao">
          ...
          <hr>
           ...
           <a href="pessoafisicamilenioV2.php?navegando=sim&status=cancelar&buscarparametro=nao">
           <img src="sairtela.png" width="42" height="38"></a>
           </td>
           </tr>
           </table>
