     ...
     WHERE TRUNC(EC.DATA_INICIO)=to_date('$datapesquisa1','dd/mm/YYYY')
	   ...
	   $achaexistecontadorbaixa3 = $conn->Execute($achaexistecontadorbaixa);
        ...
        if ($cor=="BLUE")
		{
             ...
             ?>
	         <td>
			 <font style='font-size: 11px;color: <? echo "$cor";?>;text-align:left;bold: Negrito' ><?echo "$ativi1";?>
             </font>
             ...
             {
              ?>
	         <td><font style='font-size: 11px;color: <? echo "$cor";?>;text-align:left;bold: Negrito' ><?echo "$ordembaixa";?>
             </font>
