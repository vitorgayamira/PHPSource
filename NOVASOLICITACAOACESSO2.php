...
<div  style="display: block;" id="janelagrande1acesso">
        ...
        <tr>
        <td  align=right>
        Usuário:<?echo $edusuario;?>-<?echo $nomepessoa4;?> - Abrindo Solicitação Nr.<?echo $pedidonovo;?> para  Acesso à <? echo "$razaoempresa";?>
...
<?
       ...
       if($pedidonovo>"0" and $pessoasolicita>"0" and $empresasolicita>"0"  and $lista1>"0" and  $lista2>"0"  )
       {
		 ...
		 {
		    echo "Este Usuário não Possue Privilégio para Definir</br> Funcionários de Acesso da Empresa Solicitante..veja tela de Parametrização";
		 }
