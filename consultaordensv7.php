...
?>
<form action="consultaordensv7.php" method="POST">
     ...
     while ( !$datapegou2->EOF) {
      ...
      ?>
	   ...
	   <td><? 
	    ...
	    ?></td>
	    <td><? echo $datapegou2->fields("RECOMENDACAO");?></td>
...
?>
 ...
 <div  style="display: block;" id="telapesquisa">       
        ...
        <tr>
        <td  align=right>
        <a href="consultaordensv7.php?navegando=sim&escolha=1">
