...
<tr>
				...
				<td><font style='font-size: 20px;color: black;text-align:left;bold: Negrito' >% Disponibilidade X Equipamento</font></td>
...
<table border=0 width=100%>
<tr>    			
	<td align=center><IMG src=GraficoDisponibilidade.png></td>
</tr>
</table>
...
$html.="</html>";
                 ...
                 $nomeDoArquivo="GRAFICO_DISP.pdf";
...
<table width="99%">
          ...
          <hr>
           ...
           <tr>
           <td  align=right>
           <a href="./arquivos/GRAFICO_DISP.pdf">
