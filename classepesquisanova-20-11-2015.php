...
?>
	...
	<tr>
		...
		<tr> <td>
                ...
                <td>
                        <?
							 $datapegou1pe = "SELECT ds_compo FROM componente_auxiliar WHERE cd_compo = '$componenteescolha'";
							 $datapegou2pe = $conn->Execute($datapegou1pe);
							 $componentedescricao=$datapegou2pe->fields["0"];
                ...
                <td>
                        <?
									 $datapegou1pe = "SELECT ds_atividade  FROM atividades WHERE cd_atividade = '$atividadeescolha'";

									 $datapegou2pe = $conn->Execute($datapegou1pe);
				                     $atividadedescricao=$datapegou2pe->fields["0"];
                     ...
                     <option value="">Todos Atividades</option>
                     <?
