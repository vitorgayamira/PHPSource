...
<form action="liberarservicomaximiza.php"  name="nome_formulario"  method="POST" >
...
$today = date('d/m/y H:i:s'); 
 $acha166s= "SELECT CODIGO from pessoa_bi where CD_UNIDANEGOCIO_ERP='$secaosolicitante'";
          ...
          $acha166= "SELECT id_libera_definir_funcionario LIBERA FROM usuario_grupo_bi WHERE CD_USUARIO='$codigousuario' and
          cd_pessoa='$pessoa5'";
...
?>
<center>
Seção Solicitante:<?echo $secaosolicitante;?>-Pedido:<?echo $pedido;?>
...
<?
 ...
 IF ($contador66 =="0"){
 $s= OCIParse($ora_conexao, "SELECT CADASTRO,NOME FROM FUNCIONARIO_SADEGE where cd_sec='$secaosolicitante'
              ");
 ...
 $s= OCIParse($ora_conexao, "SELECT CADASTRO,NOME FROM FUNCIONARIO_SADEGE where cd_fornecedor='$pegaforne'
              ");
 }
...
if ($escolha=="atualizar5") {
    ...
    else
    {
     echo "Existe Pedido ";
                                  ...
                                  IF ($contador66 =="0"){
 $result2xistevei89= "SELECT count(*) CONTADOR  FROM FUNCIONARIO_SADEGE where cd_sec='$secaoliberacao'";
 ...
 $result3ver89 = @OCIParse($ora_conexao, $result2xistevei89);
                                  ...
                                  for ($passa=0;$passa <=$ultimo;$passa++)
                                  {
                                   ...
                                   //if (($datainicial==null) or ($datafinal==null)){$statusgrav5="FUNP";}
                                   //ELSE{$statusgrav5="FUNC";}
