...
$dplot=array();
 ...
 $i=0;
 $s = OCIParse($ora_conexao, "select cd_mes MES,vl_custo_total TOTAL
                from aux_consulta_custo_ano where cd_maquina='$maquinapassa' order by cd_mes asc ");
