...
for ($passa1mi=1;$passa1mi <=12;$passa1mi++)
{
	  ...
	  {
		  $mostrames="Dez";
		         $achadianovo1dd= "SELECT qt_dias from meses_bi where cd_mes='$passa1mi'";
				 $datapegou2 = $conn->Execute($achadianovo1dd);
                 $numerodiasfinal=$datapegou2->fields["0"];
	  } 
      ?>
...
$datachegada2=$numerodiasfinal."/12/".$ano;
...
$achasemana1= "SELECT DISTINCT OC.CD_COMPONENTE ,OC.CD_ATIVIDADE,CA.DS_COMPO,FA.DS_FABRICA,RC.CD_INTERVALO2 INTERVALO2,RC.INTERVALO INTERVALO,RC.CD_METODO METODO
     ...
     WHERE RC.CD_COMPONENTE = OC.CD_COMPONENTE
       ...
       UNION
       SELECT DISTINCT EC.CD_COMPONENTE ,EC.CD_ATIVIDADE,CA.DS_COMPO,FA.DS_FABRICA,EC.CD_ATIVIDADE,'D' ,'1','-'
...
IF ($grupoordens=="C"){
$achasemana1= "SELECT DISTINCT EC.CD_COMPONENTE ,EC.CD_ATIVIDADE,CA.DS_COMPO,FA.DS_FABRICA,EC.CD_ATIVIDADE,'D' INTERVALO2,'1' INTERVALO,'-' METODO
      FROM EMER_COMP EC, COMPONENTE_AUXILIAR CA, MAQUINAS MA,FAMILIAS F,
           CENTRO_TRABALHOS CT, SECAOS SE, AREAS AR, FABRICAS FA
     WHERE 
	    EC.CD_COMPONENTE = CA.CD_COMPO AND 
...
IF ($grupoordens=="P"){
	...
	$achasemana1= "SELECT DISTINCT OC.CD_COMPONENTE ,OC.CD_ATIVIDADE,CA.DS_COMPO,FA.DS_FABRICA,RC.CD_INTERVALO2 INTERVALO2,RC.INTERVALO2 INTERVALO,RC.CD_METODO METODO
      FROM ROT_COMPO RC,ORDEM_COMP OC, COMPONENTE_AUXILIAR CA, MAQUINAS MA,FAMILIAS F,
      CENTRO_TRABALHOS CT, SECAOS SE, AREAS AR, FABRICAS FA
