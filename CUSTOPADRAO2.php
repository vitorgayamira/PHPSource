...
<titulogeral><? echo "$titulo";?>- <?echo "Intervalo:".$datapesquisainicial." Até ".$datapesquisafinal;?></titulogeral>
...
$sm25 = $conn->Execute($sm5);
 ...
 style='background:white;' width="100%" align="center" class="tabela1">
  ...
  TO_CHAR(SUM(VL_PARTICIPACAO),'999990.999')  PART from aux_consulta_custo  where VL_CUSTO_TOTAL >'0' GROUP BY CD_MAQUINA
  order by PART desc";
