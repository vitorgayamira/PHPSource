...
$titulo="Cadastrando Pessoa jurídica";
$programadelete="classeelimina.php";
$programaupdate="classeupdate.php";

$chacontadorgeral="SELECT * from (SELECT CODIGO,DESCRICAO Razão_Social,NR_INSCRICAO,NR_CNPJ,NM_LOGRADOURO,DS_COMPLEMENTO,NR_CEP,NM_BAIRRO,	
...
$titulojanelaupdate="Atualizando  Pessoa Jurídica";
$titulojanelaelimina="Eliminando  Pessoa Jurídica";
$titulojanelainsert="Cadastrando  Pessoa Jurídica";
$titulojanelapesquisa="Pesquisando Cadastro de Pessoa Jurídica";
