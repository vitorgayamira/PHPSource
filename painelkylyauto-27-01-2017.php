...
ini_set('display_errors', '1');// NÃO HABILITAD 
					 ...
					 $nomeempresaconexao="KYLY";
					 /*VARIAVEIS QUE MOSTRAM  NO LOG DE ERRO*/
					 //$titulo=$_POST['titulo'];
					 $banco=NULL;
					 $codigousuario=NULL;
					 $localbanco=NULL;
...
<meta http-equiv="refresh" content="30;URL=painelkylyauto.php?banco=<?echo $banco;?>&codigousuario=<?echo $codigousuario;?>&localbanco=<?echo $localbanco;?>">
