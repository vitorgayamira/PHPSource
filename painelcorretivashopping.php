...
<meta http-equiv="refresh" content="30;URL=painelcorretivashopping.php?banco=<?echo $banco;?>&codigousuario=<?echo $codigousuario;?>&localbanco=<?echo $localbanco;?>">
...
$fabricapesquisa=$codigoproximoregitro2->fields["0"];
 ...
 <CENTER><font style='font-size: 23px;color: BLACK;text-align:left;bold: Negrito' >Monitoramento Manutenção  Unidade:<?echo $fabricapesquisa;?></font></BR>
...
<?
 ...
 $codigoproximoregitro1 = "SELECT  count(*) CONTADOR
                      ...
                      where a.NRORDEM=b.numero  and a.cd_fabrica='$fabricapesquisa' and a.andamento  not in ('FINALIZADO')";
...
<table  width="1000" class="bordasimples">
 ...
 <?
  ...
  $achaordens1 = "SELECT  NRORDEM ,ANDAMENTO ,
                      ...
                      FROM   AUX_PAINEL_CORRETIVA_W WHERE NRORDEM in (select NUMERO FROM EMER_COMP ) and cd_fabrica='$fabricapesquisa'
