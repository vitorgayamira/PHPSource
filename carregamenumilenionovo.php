...
$descricaopasta=$result5nome57->fields["PASTA"];
      ?>
            ...
            while ( !$result5nome58->EOF) {
             ...
             ?>
            <a href='<?echo "$programa1";?>?novologin=nao&navegando=sim' style="text-decoration:none;font-size: 12px;color: black;text-align:left;bold: Negrito"><b><? echo "$subdescricao";?></b></a></a>|
