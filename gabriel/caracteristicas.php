...
$programa="caracteristicas.php";
$titulo="Record Characteristics";
$programadelete="classeelimina.php";
$programaupdate="classeupdate.php";

$chacontadorgeral="SELECT a.id_caracteristica ID,a.caracteristica Characteristics FROM caracteristica_spray a where a.id_caracteristica >0
";
//aqui tem o label no select
$chacontadorgeralupdate="SELECT a.id_caracteristica ,a.caracteristica   FROM caracteristica_spray a where a.id_caracteristica >0";
//diferenca é que nao tem label

$chacontadorgeralinsert="SELECT id_caracteristica,caracteristica FROM caracteristica_spray where id_caracteristica in (select max(id_caracteristica) from caracteristica_spray)";


$chacontadorgeralpagina="SELECT count(*) CONTADOR  from caracteristica_spray";

$nometabelaparapassar="caracteristica_spray";
$nomecolunaparapassar="a.id_caracteristica";
$nomecolunaparapassaracao="id_caracteristica";
...
$titulojanelaupdate="Atualizando  Characteristics";
$titulojanelaelimina="Eliminando  Characteristics";
$titulojanelainsert="Cadastrando  Characteristics";
$titulojanelapesquisa="Pesquisando Characteristics";
