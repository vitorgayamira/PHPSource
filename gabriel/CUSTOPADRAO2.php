...
<form method="POST">
    ...
    <div id="mostraconteudo33">
        ...
        if (!IsSet($escolha) or ($escolha == "1")) {
            $texto = "$titulo - Intervalo $datapesquisainicial Até $datapesquisafinal";
            ?>
            <br/>
            <div class="titulogeral"><? echo $texto; ?>
            </div>
          ...
          ";
            ...
            while (!$sm2->EOF) {
                ...
                $usu18ussG = "insert into aux_consulta_custo(CD_COMPONENTE,VL_CUSTO_MATERIAL,
                  VL_CUSTO_PECAS,VL_CUSTO_TOTAL,VL_PARTICIPACAO,cd_maquina) VALUES('$codigoequipamento','$valorcusto','0','0','0','$codigomaquina')";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="fabricaescolha" style="background-color:#8B8378;color: white;">
                                <option value="<? echo $fabricaescolha; ?>">Unidade:<? echo $fabricaescolha; ?>
