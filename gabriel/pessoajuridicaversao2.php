...
<form action="pessoajuridicaversao2.php"  name="teste"  method="POST" >
...
require("carregamenumilenio.php");
...
<a href="pessoajuridicaversao2.php?navegando=sim&status=novo&codigoachou=<?echo $codigoachou;?>&buscarparametro=nao&simboloobrigatoriocpnpj=<?echo $simboloobrigatoriocnpj;?>&simboloobrigatoriocidade=<?echo $simboloobrigatoriocidade;?>&simboloobrigatorioemail=<?echo $simboloobrigatorioemail;?>
...
onMouseUp="this.style.border='thin outset #8B8B7A';">
<div style="font-size: 12px; font-weight: bold;">
<a href="pessoajuridicaversao2.php?navegando=sim&status=editar&codigoachou=<?echo $codigoachou;?>&buscarparametro=nao&simboloobrigatoriocnpj=<?echo $simboloobrigatoriocnpj;?>&simboloobrigatoriocidade=<?echo $simboloobrigatoriocidade;?>&simboloobrigatorioemail=<?echo $simboloobrigatorioemail;?>
&acao=1&nome=<?echo $nome;?>&cnpj=<?echo $cnpj;?>&cidadegrava=<?echo $cidadegrava;?>&emailgrava=<?echo $emailgrava;?>"
style="text-decoration:none;color: black;">Retornar</a>
</div>
</td>
<?
          ...
          <td width="70" height="30" align="center" bgcolor="#8B8B7A" style="border: thin outset #8B8B7A;"
           ...
           onMouseUp="this.style.border='thin outset #8B8B7A';">
           <div style="font-size: 12px; font-weight: bold;">
              <a href="pessoajuridicaversao2.php?navegando=sim&status=cancelar&codigoachou=<?echo $codigoachou;?>&buscarparametro=nao"
          ...
          <td width="70" height="30" align="center" bgcolor="#8B8B7A" style="border: thin outset #8B8B7A;"
           ...
           onMouseUp="this.style.border='thin outset #8B8B7A';">
           <div style="font-size: 12px; font-weight: bold;">
              <a href="pessoajuridicaversao2.php?navegando=sim&buscarparametro=sim" style="text-decoration:none;color: black;">Consultar</a>
           </div>
          </td>
           ...
           onMouseUp="this.style.border='thin outset #8B8B7A';">
           <div style="font-size: 12px; font-weight: bold;">
              <a href="pessoajuridicaversao2.php?navegando=sim&status=novo&acao=null" style="text-decoration:none;color: black;">Incluir</a>
           </div>
          </td>
          ...
          <td  width="70" height="30" align="center" bgcolor="#8B8B7A" style="border: thin outset #8B8B7A;"
           ...
           onMouseUp="this.style.border='thin outset #8B8B7A';">
           <div style="font-size: 12px; font-weight: bold;" >
              <a href="pessoajuridicaversao2.php?navegando=sim&status=elimina&codigoachou=<?echo $codigoachou;?>buscarparametro=nao"
    ...
    <? if ($buscarparametro=="sim"){?>
         ...
         <div  style="display: block;" id="primeiro">
          ...
          ?>
           ...
           onMouseUp="this.style.border='thin outset #8B8B7A';">
           <div style="font-size: 12px; font-weight: bold;">
              <a href="pessoajuridicaversao2.php?navegando=sim&status=editar&codigoachou=<?echo $codigoachoufinal;?>&buscarparametro=nao"
      ...
      ?>
          ...
          <font style='font-size: 17px;color: black;text-align:left;bold: Negrito' ><?echo "Eliminar Registro";?><br>
           ...
           onMouseUp="this.style.border='thin outset #8B8B7A';">
           <div style="font-size: 12px; font-weight: bold;">
              <a href="pessoajuridicaversao2.php?navegando=sim&status=finalizarexclusao&codigoachou=<?echo $codigoachou;?>"
              style="text-decoration:none;color: black;">Confirma</a>
           </div>
           </td>
