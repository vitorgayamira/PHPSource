...
<meta http-equiv="refresh" content="30;URL=painelsemana1.php">
<form>
    ...
    CODIGO IN (SELECT CD_EMPRESA FROM USUARIO_BI  WHERE nm_usuario='$edusuario')";
        ...
        <div style="text-align: center;"><font style='font-size: 23px;color: BLACK;text-align:left;bold: Negrito'>Monitoramento
                Manutenção
                Corretiva </font><br/>
            ...
            <div id="envolve">
                ...
                <div id="div_1">
                    <h1 style='font-size: 12px;color: black;text-align:center;bold: Negrito text-decoration: none'>
                        Equipe Mecânica</h1>
                    <br/>
