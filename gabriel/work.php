...
$chacontadorgeral="SELECT a.id_work ID,a.work Work FROM work a where a.id_work >0 order by a.id_work asc
";
//aqui tem o label no select
$chacontadorgeralupdate="SELECT a.id_work ,a.work   FROM work a where a.id_work >0";
//diferenca é que nao tem label

$chacontadorgeralinsert="SELECT id_work,work FROM work where id_work in (select max(id_work) from work)";


$chacontadorgeralpagina="SELECT count(*) CONTADOR  from work";

$nometabelaparapassar="work";
$nomecolunaparapassar="a.id_work";
$nomecolunaparapassaracao="id_work";
...
$titulojanelaupdate="Atualizando  Work";
$titulojanelaelimina="Eliminando  Work";
$titulojanelainsert="Cadastrando  Work";
$titulojanelapesquisa="Pesquisando Work";
