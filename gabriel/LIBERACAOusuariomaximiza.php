<form action="LIBERACAOusuariomaximiza.php" method="POST">
<?
...
$programa="LIBERACAOusuariomaximiza.php";
...
<center><font style='font-size: 26px;color: red;text-align:left;bold: Negrito' >Liberando Acesso</font>
...
echo "Codigo Usuario: ".$codigousuario;
echo "Banco: ".$banco;
...
<a href="LIBERACAOusuariomaximiza.php?escolha=2&mes=<?echo $mes;?>&ano=<?echo $ano;?>
...
<a href="LIBERACAOusuariomaximiza.php?codigousuario=<?echo $codigousuario;?>&codigoempresa=<?ECHO $codigoempresa;?>
...
<a href="LIBERACAOusuariomaximiza.php?pagina=1&escolha=ELIMINAASSOCIACAO&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
...
<a href="LIBERACAOusuariomaximiza.php?pagina=1&escolha=novafuncao1&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
&codigoempresa=<?echo $codigoempresa;?>&navegando=sim&banco=<?echo $banco;?>">
<img width=50 height=60  BORDER=1 src="novatela.GIF" ></a>

<a href="LIBERACAOusuariomaximiza.php?pagina=1&escolha=novapasta1&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
&codigoempresa=<?echo $codigoempresa;?>&navegando=sim&banco=<?echo $banco;?>">
<img width=50 height=60  BORDER=1 src="novapasta.GIF" ></a>

<a href="LIBERACAOusuariomaximiza.php?escolha=mudarusuariogrupo&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
...
<a href="LIBERACAOusuariomaximiza.php?escolha=eliminarusuariogrupo&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
...
<a href="LIBERACAOusuariomaximiza.php?escolha=listausuario7&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
...
<a href="LIBERACAOusuariomaximiza.php?pagina=1&escolha=novogrupo&mes=<?echo $mes;?>&ano=<?echo $ano;?>
&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>
&codigousuario=<?echo $codigousuario;?>
&codigoempresa=<?echo $codigoempresa;?>&navegando=sim&banco=<?echo $banco;?>">
...
*/
if ($statusmaster=="N"){
$sql99 ="SELECT a.nr_sequencia SEQUENCIA,b.ds_funcao DESCRICAO1,c.descricao DESCRICAO2,d.ds_pasta PASTA from
