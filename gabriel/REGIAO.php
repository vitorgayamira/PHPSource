...
<CENTER><font style='font-size: 19px;color: BLACK;text-align:left;bold: Negrito' >Cadastro de Regiões </font></BR>
...
<a href="<?echo $programa;?>?codigousuario=<?echo $codigousuario;?>&codigoempresa=<?ECHO $codigoempresa;?>
&navegando=sim&banco=<?ECHO $banco;?>&escolha=1&baseoracle=<?ECHO $baseoracle;?>"><img width=50 height=60 BORDER=1 src="OTIMIZAR.GIF">
</a>
...
<?
 ...
 $s = OCIParse($ora_conexao, "select CD_REGIAO,DS_REGIAO FROM REGIAO ORDER  by DS_REGIAO ASC");
        OCIExecute($s, OCI_DEFAULT);
        While (OCIFetch($s)) {

          $codigo=ociresult($s, "CD_REGIAO") ;
          $descricao=ociresult($s, "DS_REGIAO") ;
