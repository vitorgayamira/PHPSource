...
<form action="consultaordensv6.php" method="POST">
    ...
    <div id="mostraconteudo33">
                    ...
                    <tr class="tabelaLinha<? echo $classe; ?>">
                        ...
                        IF ($grupoordens == "P") {
                            ...
                            IF ($statuspega == "G") {
                                ...
                                ?>
                                <td>
                                    <a href="baixamanutencao_versao5.php?escolha=maodeobra&numeroordempesquisa=<? echo $ordem; ?>&navegando=sim&banco=<? echo $banco; ?>&ambiente=<? ECHO $ambiente; ?>&baseoracle=<? ECHO $baseoracle; ?>&localbanco=<? ECHO $localbanco; ?>&atividadegrava=<? ECHO $atividaderecuperada; ?>&fabricapesquisa=<? ECHO $fabricapesquisa; ?>"
                                       style="text-decoration:none"><? echo $datapegou2->fields("NUMERO"); ?></a></td>
                            <?
                            } else {
                            ...
                            IF ($statuspega == "G") {
                                ...
                                <td>
                                    <a href="baixamanutencao_versao5.php?escolha=maodeobra&numeroordempesquisa=<? echo $ordem; ?>&navegando=sim&banco=<? echo $banco; ?>&ambiente=<? ECHO $ambiente; ?>&baseoracle=<? ECHO $baseoracle; ?>&localbanco=<? ECHO $localbanco; ?>&atividadegrava=<? ECHO $atividaderecuperada; ?>&fabricapesquisa=<? ECHO $fabricapesquisa; ?>"
                                       style="text-decoration:none"><? echo $ordem; ?></a></td>
                            <?
                            } else {
                                ?>
                                <td><? echo $ordem; ?></td>
                            ...
                            <td><? echo $datapegou2->fields("DATA"); ?> <? echo $horainicio77; ?>
                                :<? echo $minutoinicio77; ?></td>
                        ...
                        <td width="5%">
                            <div style="text-align: center;"><a
                                    href="ordempdf.php?escolha=1&navegando=sim&banco=<? echo $banco; ?>&localbanco=<? echo $localbanco; ?>&usuario=<? echo $usuario; ?>&ordem=<? echo $ordem; ?>">
                                    <IMG src="imprimirnovo.png" width="30" height="30"></a>
                        </td>
        ...
        if ($escolha == "pesquisa") {
            ...
            <div id="telapesquisa" class="mostraCaixa" style="height:300px;">
                ...
                <table class="letraCaixa">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="solicitantepesquisainicial">
                                <option
                                    value="<? echo $solicitantepesquisainicial; ?>"><? echo $solicitantepesquisainicial; ?></option>
                 ...
                 DISTINCT CD_SOLICITANTE FROM EMER_COMP) ";
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="numeroordempesquisa" value="<? echo $numeroordempesquisa; ?>"
                                   size="10">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="codigomaquina" value="<? echo $codigomaquina; ?>" SIZE="5">
                        </td>
                    </tr>
                    ...
                    if ($grupoordens == "P") {
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="atividadepesquisa">
                                    <option
                                        value="<? echo $atividadepesquisa; ?>"><? echo $atividadepesquisa; ?></option>
                                    <option value="">Todas</option>
                                    <?
                    ...
                    <tr>
                        ...
                        <td>
                            <input type=date name="dataparabuscar1" value="<? echo $dataparabuscar1; ?>">
