...
<meta http-equiv="refresh"
      content="30;URL=painelcorretivateste_view_kyly2.php?banco=<? echo $banco; ?>&codigousuario=<? echo $codigousuario; ?>&localbanco=<? echo $localbanco; ?>">
...
<form>
    ...
    <div style="text-align: center;"><font style='font-size: 23px;color: BLACK;text-align:left;'>Monitoramento
            Manutenção
            Corretiva </font><br/>


        <img width=20 height=20 BORDER=0 src="legendamaximiza1.jpg">Maq.Parada <img width=20 height=20 BORDER=0
                                                                                    src="legendamaximiza2.jpg">Maq.Não
        Parada
        ...
        <div id="envolve">
            ...
            <div id="div_1">
                <h1 style='font-size: 12px;color: black;text-align:center;'>Equipe
                    Mecânica</h1>
                <br/>

                <div style="text-align: center;">
                    <table width="500" class="bordasimples">
                        ...
                        EMER_COMP WHERE NUMERO='$ordemmostra'";
                            ...
                            <td bgcolor="<? echo $cor; ?>" width="100" height="140" valign="top">
                                ...
                                <h1 style='font-size: 15px;color: black;text-align:left;'>
                                    <? echo "$ordemmostra<br/>"; ?>
                                    <h1 style='font-size: 12px;color: black;text-align:left;'>
                                        <? echo "$descricacomponente<br/>"; ?>
                                        <h1 style='font-size: 11px;color: black;text-align:left;'><? echo "$aberturamostra<br/>"; ?>
                                            <h1 style='font-size: 12px;color: black;text-align:left;'>
                                                <? echo "$descricaomotivo<br/>"; ?><? echo "$nome66<br/>"; ?>
                                                <h1 style='font-size: 11px;color: black;text-align:left;'><? echo "$dataaberturamostra"; ?>
                            </td>
                            <?
