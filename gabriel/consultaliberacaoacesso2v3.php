...
<form action="consultaliberacaoacesso2v3.php" method="POST" name="nome_formulario" onsubmit="return valida_numero();">
...
ELSE
{
    ...
    $acha177D = "SELECT DESCRICAO,CD_UNIDANEGOCIO_ERP FROM pessoa_bi WHERE DESCRICAO='$empresasolicita'";
          $res77D = mysql_db_query($banco,$acha177D,$conexao);
          $valor677D=mysql_fetch_array($res77D);
          $DESCRICAOempresainicial=$valor677D["DESCRICAO"];
          $codigosecao7=$valor677D["CD_UNIDANEGOCIO_ERP"];
 ...
 <font style='font-size: 24px;color: red;text-align:left;bold: Negrito' >Pessoal Autorizado </font></br>
        ...
        Cpf:<input type="txt" name="cpfpesquisa"  id="numero" style="background-color:#8B8378;color: white;" >
        
        RG:<input type="txt" name="rgpesquisa" id="numero2" style="background-color:#8B8378;color: white;" >
