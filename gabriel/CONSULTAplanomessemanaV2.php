...
<form action="CONSULTAplanomessemanaV2.php" name="nome_formulario" id="nome_formulario" method="POST">
    ...
    <div id="mostraconteudo33">
        ...
        if (!IsSet($escolha)) {
            ...
            <? if ($escolha == 1) { ?>
                <div class="tituloCaixa"> - Semana:<? echo $semanapegou; ?> M&ecirc;s:<? echo $mes; ?>
                    /<? echo $ano; ?></div>
            <? } ?>
            <?
       ...
       ";
                                        ...
                                        if ($cor == "BLUE") {
                                            ...
                                            IF ($grupoordens == "P") {
                                                ...
                                                ?>
                                                <td>
                                                    <a href="CONSULTAplanomessemanaV2.php?pagina=1&tela=0&mes=<? echo $mes; ?>&ano=<? echo $ano; ?>&turnopesquisa=<? echo $turnopesquisa; ?>&curva=<? echo $curva; ?>&ano=<? echo $ano; ?>&codigousuario=<? echo $codigousuario; ?>&listaordemselecionada=<? echo $ordembaixa; ?>&codigoempresa=<? echo $codigoempresa; ?>&navegando=sim&banco=<? echo $banco; ?>&ambiente=<? ECHO $ambiente; ?>&baseoracle=<? ECHO $baseoracle; ?>&localbanco=<? ECHO $localbanco; ?>&escolha=verservico&atividadegrava=<? ECHO $ativi1; ?>&fabricapesquisa=<? ECHO $fabricapesquisa; ?>&semanapegou=<? ECHO $semanapegou; ?>&semanapegoumostrar=<? ECHO $semanapegoumostrar; ?>&compo1=<? ECHO $compo1; ?>"><span
                                                            style='font-size: 9px;color: <? echo "$cor"; ?>;text-align:left;'>
                                                        <? echo "$ordembaixa"; ?></a>
                    ...
                    while (!$mostragrid1->EOF) {
                        ...
                        <tr>
                            ...
                            IF ($compo1 == $compoanterior) {
                                ...
                                ?>
                                <td>
                                    <h1 style='font-size: 9px;color: black;text-align:left;'>
                                        <?
       ...
       ");
                                    ...
                                    if ($cor == "BLUE") {
                                        ...
                                        IF ($grupoordens == "P") {
                                            ?>
                                            <td>
                                                <h1 style='font-size: 8px;color:<? echo "$cor"; ?>;text-align:left;'><? echo "Mostra1:$ativi1"; ?>
                                                </h1>
                                            ...
                                            ?>
                                            <td>
                                                <h1 style='font-size: 8px;color:<? echo "$cor"; ?>;text-align:left;'><? echo "mostra2:$ordembaixa"; ?>
                                                </h1>
