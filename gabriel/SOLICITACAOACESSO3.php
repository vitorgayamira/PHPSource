...
<div  style="display: block;" id="janelagrande1acesso">
        ...
        <tr>
        <td  align=right>
        Usuário:<?echo $edusuario;?>-<?echo $nomepessoa4;?>
		Pedido:<?echo $codigoachou;?></br>
		Autorizando  Solicitação de Acesso à <? echo "$razaoempresa";?> solitado por:<? echo "$razaosolicitante";?>
...
{
		    echo "Este Usuário não Possue Privilégio para liberar </br> Funcionários de Acesso da Empresa Solicitante..veja tela de Parametrização";
}
