...
<form method="POST">
    ...
    <div id="icones">
        ...
        <a href="http://186.202.46.98:8080/osi/"><img src="imagens/solicitacao.png" align="center"></a><br/>
        <br/>
    ...
    if ( (empty($fabricapesquisa) or empty($anopesquisa)) && $escolha != "pesquisa") {
        ?>
    ...
    <table class="tabela1">
        ...
        <tr>
          ...
          from AUX_CONSULTA_CUSTO_ANO where cd_mes='$mesamostra7'";
                    ...
                    $valorcustototalmostra9 = number_format($valorcustototal9, 0, ',', '.');
        ...
        <div id="telapesquisa" class="mostraCaixa">
            ...
            <table class="letraCaixa">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="anopesquisa">
                    </td>
                </tr>
