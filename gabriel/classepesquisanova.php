...
$escolha = ($escolha == "") ? $_GET['escolha'] : $escolha;

require("conexaoadodb_oracle.php");
require_once('manipulasql.class_oraclenovo.php');
$titulo = "Plano Anual";

$display = ($escolha == "sem pesquisa") ? "none" : "block";
?>


<div id="telapesquisa" class="mostraCaixa" style="height: 300px; display: <? echo $display; ?>;">
    ...
    <table class="letraCaixa" >
        <tr>
            ...
            <td>
                ...
                if ($fabricaescolha == "99999") {
                    $fabricapesquisades = "Todas";
                }


                ?>

                <select name="fabricaescolha" onchange="this.form.submit()">
        ...
        <tr>
            ...
            <td>
                <select name="grupoordens" onchange="this.form.submit()">
                    ...
                    <option value="C">N&atilde;o Planejadas</option>
        ...
        <tr>
            ...
            <td>
                ...
                <select name="equipamentoescolha" onchange="this.form.submit()">
                    <option value="<? echo $equipamentoescolha; ?>"><? echo $equipamentoescolha; ?>
        ...
        <tr>
            ...
            <td>
                ...
                <select name="familiaescolha" onchange="this.form.submit()">
                    <option value="<? echo $familiaescolha; ?>"><? echo $familiaescolha; ?>
                        -<? echo $familiadescricao; ?></option>
                    <option value="">Todos Equipamentos</option>
                    <?
     ...
     WHERE  EC.CD_COMPONENTE = CA.CD_COMPO
       ...
       FA.CD_FABRICA like '%$fabricapesquisa%'";
        ...
        <? if ($programa == "CONSULTAplanomesV2.php") { ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="mes" onchange="this.form.submit()">
                        <option value="<? echo $mes; ?>">M&ecirc;s:<? echo $mes; ?></option>
        ...
        if ($programa == "CONSULTAplanomessemanaV2.php") {
            ...
            <tr>
                ...
                <td>
                    <select name="semanapegou" onchange="this.form.submit()">
    ...
    <? $btn_concluir = $programa .'?navegando=sim&escolha=1&fabricaescolha=<' . $fabricaescolha . '&grupoordens=' . $grupoordens .
                       '&equipamentoescolha=' . $equipamentoescolha . '&ano=' . $ano . '&familiaescolha='                        .
                       $familiaescolha . '&atividadeescolha='. $atividadeescolha . '&componenteescolha=' . $componenteescolha    .
                       '&mes='. $mes . '&semanapegou=' . $semanapegou;
    ?>

    <div id="divBotoes">
        <input id="btn_voltar" type="button" VALUE="VOLTAR" class="botaoVermelho"
               onclick="window.location='<? echo $programa; ?>'">
        <input id="btn_concluir" type="button" VALUE="CONCLUIR" class="botaoVermelho"
               onclick="window.location='<? echo $btn_concluir; ?>'">
    </div>
