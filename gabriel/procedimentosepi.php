...
<form action="procedimentosepi.php"  name="formulario" method="POST">
...
<CENTER><font style='font-size: 19px;color: BLACK;text-align:left;bold: Negrito' >Cadastro de Procedimentos  - EPI </font></BR>



<a href="procedimentosepi.php?pagina=1&escolha=novoregistro&tela=0&mes=<?echo $mes;?>&ano=<?echo $ano;?>&turnopesquisa=<?echo $turnopesquisa;?>&curva=<?echo $curva;?>&codigousuario=<?echo $codigousuario;?>&codigoempresa=<?echo $codigoempresa;?>&navegando=sim&banco=<?echo $banco;?>
...
<a href="procedimentosepi.php?codigousuario=<?echo $codigousuario;?>&codigoempresa=<?ECHO $codigoempresa;?>
...
<a href="procedimentosepi.php?pagina=1&escolha=novoregistro&tela=1&mes=<?echo $mes;?>&ano=<?echo $ano;?>
...
<?
 ...
 $s = OCIParse($ora_conexao, "select CD_PROCEDIMENTO,NM_PROCEDIMENTO,DS_PROCEDIMENTO FROM PROCEDIMENTO_SEGURANCA ORDER  by DS_PROCEDIMENTO ASC");
        OCIExecute($s, OCI_DEFAULT);
        While (OCIFetch($s)) {

          $codigo=ociresult($s, "CD_PROCEDIMENTO") ;
          $descricao=ociresult($s, "NM_PROCEDIMENTO") ;
          $norma=ociresult($s, "DS_PROCEDIMENTO") ;
   ...
   <td><?echo $descricao;?> </td>
    <td  align="left"><textarea disabled cols="50" rows="25" name="mensagem"><?echo $norma;?></textarea>
</td>
...
<hr>
<center>
Criando Procedimento</br>

Código :<input type="txt" name="codigopro" size="35"  >

Descrição :<input type="txt" name="nomeprocedimento" size="35"  ></br>
<center>
<textarea  cols="36" rows="20" name="norma">Descritivo da Norma..</textarea></br>
