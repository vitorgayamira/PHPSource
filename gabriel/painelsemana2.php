...
?>
    ...
    <div class="tituloCaixa"><? echo "$titulo"; ?> -Semana:<? echo $semanapegou; ?> Mês:<? echo $mes; ?>/<? echo $ano; ?></div>
...
if (!IsSet($escolha) or ($escolha == "1")) {
    ...
    if ($mesinicio == $mesfinal) {
        ...
        <table border=0
            ...
            <tr>
                ...
                IF ($grupoordens == "T") {
                    ...
                    $achasemana1 = "SELECT DISTINCT OC.CD_COMPONENTE ,OC.CD_ATIVIDADE,CA.DS_COMPO
     ...
     WHERE RC.CD_COMPONENTE = OC.CD_COMPONENTE
       ...
       UNION
       SELECT DISTINCT EC.CD_COMPONENTE ,EC.CD_ATIVIDADE,CA.DS_COMPO
     ...
     WHERE TRUNC(EC.DATA_INICIO) >=to_date('$datapesquisainicial','dd/mm/YYYY')
       ...
       ORDER BY CD_COMPONENTE,CD_ATIVIDADE";
                ...
                IF ($grupoordens == "C") {
                    $achasemana1 = "SELECT DISTINCT EC.CD_COMPONENTE ,EC.CD_ATIVIDADE,CA.DS_COMPO
      FROM EMER_COMP EC, COMPONENTE_AUXILIAR CA, MAQUINAS MA,FAMILIAS F,
           CENTRO_TRABALHOS CT, SECAOS SE, AREAS AR, FABRICAS FA
     WHERE TRUNC(EC.DATA_INICIO) >=to_date('$datapesquisainicial','dd/mm/YYYY')
       AND TRUNC(EC.DATA_INICIO) <=to_date('$datapesquisainicial','dd/mm/YYYY')
       ...
       ";
                        ...
                        if ($cor == "BLUE") {
                            IF ($grupoordens == "P") {
                                ?>
                                <td>
                                    <h1 style='color:<? echo "$cor"; ?>;text-align:left;bold: Negrito text-decoration: none'><? echo "$ativi1"; ?>
                                    </h1>
                                ...
                                ?>
                                <td>
                                    <h1 style='color:<? echo "$cor"; ?>;text-align:left;bold: Negrito text-decoration: none'><? echo "$ordembaixa"; ?>
                                    </h1>
 ...
 mso-border-insideh:.5pt solid windowtext;mso-border-insidev:.5pt solid windowtext' width="100%">
            <tr>
                ...
                for ($passa12 = $contadoriteminicial2; $passa12 <= $ultimodiaperiodo1; $passa12++) {
                    ...
                    if ($dia == "Dom") {
                        ?>
                        <td><? echo $dia; ?></br><? echo $passa12; ?></td>
                        <?
                    } else {
                        ?>
                        <td><? echo $dia; ?></br><? echo $passa12; ?></td>
                ...
                for ($passa13 = 1; $passa13 <= $ultimodia; $passa13++) {
                    ...
                    if ($dia == "Dom") {
                        ?>
                        <td><? echo $dia; ?></br><? echo $passa13; ?></td>
                        <?
                    } else {
                        ?>
                        <td><? echo $dia; ?></br><? echo $passa13; ?></td>
       ...
       ";
                            ...
                            if ($cor == "BLUE") {
                                IF ($grupoordens == "P") {
                                    ?>
                                    <td>
                                        <h1 style='font-size: 8px;color:<? echo "$cor"; ?>;text-align:left;bold: Negrito text-decoration: none'><? echo "$ativi1"; ?>
                                        </h1>
                                    ...
                                    ?>
                                    <td>
                                        <h1 style='font-size: 8px;color:<? echo "$cor"; ?>;text-align:left;bold: Negrito text-decoration: none'><? echo "$ordembaixa"; ?>
                                        </h1>
