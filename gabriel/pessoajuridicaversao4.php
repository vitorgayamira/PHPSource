...
<form action="pessoajuridicaversao4.php"  name="teste"  method="POST" >
...
if(empty($nome)   or empty($cidadegrava) or empty($fone3) or empty($cep) or empty($codigosadege))
{
...
else
{
        ...
        $achacad7= "SELECT COUNT(*) CONTADOR from pessoa_bi
           where cod_sadege='$codigosadege' and codigo not in ('$codigoachou') ";
            $achacad27= mysql_db_query($banco,$achacad7,$conexao);
            $achacad37=mysql_fetch_array($achacad27);
            $quantos7=$achacad37["CONTADOR"];



     if ($quantos7 >"0"){
              $mensagemtela="N„o foi PossÌvel Incluir Codigo Sadege j· esta em USO em outro Pessoa JurÌdica ";
...
if(empty($nome)   or empty($cidadegrava)  or empty($cep) or empty($codigosadege))
{
      $mensagemtela="Existem Campos ObrigatÛrios N„o Preenchidos</br>";
      $statusnovapessoa="nao";
      $status="novo";
...
<a href="pessoajuridicaversao4.php?navegando=sim&status=novo&statusnovapessoa=sim">
<img src="incluirnovocva.png" width="42" height="38" ></a>

<a href="pessoajuridicaversao4.php?navegando=sim&status=buscarparametro&statusnovapessoa=nao&acaoparametro=selecionar&iniciotela=sim">
...
<a href="pessoajuridicaversao4.php?navegando=sim&status=cancelar&statusnovapessoa=sim">
<img src="sairtela.png" width="42" height="38"></a>
...
<a href="pessoajuridicaversao4.php?navegando=sim&status=buscarparametro&acaoparametro=selecionar">
<IMG src="selecionarnovocva.png" width="42" height="38" ></a>

<a href="pessoajuridicaversao4.php?navegando=sim&status=buscarparametro&acaoparametro=eliminar&codigopessoaatual=<?echo $codigoachou;?>">
<IMG src="eliminarnovocva.png" width="42" height="38" ></a>


<a href="pessoajuridicaversao4.php?navegando=sim&status=cancelar">
<img src="sairtela.png" width="42" height="38"></a>
...
from pessoa_bi a, cidade b
          ...
          <?
                    ...
                    P·gina:<? echo "$pagina_atual";?>/<? echo "$paginas";?>
                     <a href="pessoajuridicaversao4.php?navegando=sim&buscarparametro=nao&pagina_atual=<?echo $anteriorpagina;?>">
                     <img src="setaesquerda.png" width="20" height="14" ></a>
                    <a href="pessoajuridicaversao4.php?navegando=sim&buscarparametro=nao&pagina_atual=<?echo $proximapagina;?>">
...
if (($status=="editar") or ($statusnovapessoa=="selecionar")){
                ...
                //{
                 ...
                 PJ_TELEFONE1 FONE1 ,cd_unidade ASSOCIADA,ID_INTEGRADO,cd_pessoa_associada ASSOCIADA2,cod_sadege SADEGE
          ...
          Validar</a>
					...
					<?
                     ...
                     <td><input type="txt" name="codigosadege"  value="<?echo $codigosadege5;?>" size="25" style="border-color:red">
...
<?
	    ...
	    <td width="5%"><a href="pessoajuridicaversao4.php?navegando=sim&status=editar&codigoachou=<?echo $codigopasa;?>&acaoparametro=<?echo $acaoparametro;?>">
 ...
 <td align=right>
    ...
    <a href="pessoajuridicaversao4.php?navegando=sim&pagina_atual=<?echo $proximapagina;?>&status=buscarparametro&acaoparametro=selecionar&nomebusca=<?echo $nomebusca;?>&codigocidade=<?echo $codigocidade;?>&tipopessoasop=<?echo $tipopessoasop;?>">
    <img src="setadireita.png" width="20" height="14" ></a>
    <a href="pessoajuridicaversao4.php?navegando=sim&buscarparametro=sim&pagina_atual=<?echo $anteriorpagina;?>&status=buscarparametro&acaoparametro=selecionar&nomebusca=<?echo $nomebusca;?>&codigocidade=<?echo $codigocidade;?>&tipopessoasop=<?echo $tipopessoasop;?>">
    <img src="setaesquerda.png" width="20" height="14" ></a>
    </td>
 </tr>
 </table>
...
<div  style="display: block;" id="mostraexclusao">
 ...
 <table width="99%">
          ...
          <hr>
           ...
           <a href="pessoajuridicaversao4.php?navegando=sim&status=cancelar&buscarparametro=nao">
           <img src="sairtela.png" width="42" height="38"></a>
           </td>
           </tr>
           </table>
