<?
         ...
         //echo "<br> contador existencia: ".$contadorexistencia77;
          ...
          else
          {
           ...
           $nome=strtoupper($nome);//converte maiuscula
                 ...
                 else
                 {
                  ...
                  cep,estado,cidade,TELEFONE,TELEFONE_CELULAR,
                  ...
                  '$ruagrava','$bairrograva','$cep','$estadograva',
